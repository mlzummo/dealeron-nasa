        ...
        mounted() {
            document.addEventListener('DOMContentLoaded', function () {
                ...
                var checkWord = function () {
                    var textInputValue = document.getElementById('terminalTextInput').value.trim(); //get the text from the text input to a variable
                    var textInputValueLowerCase = textInputValue.toLowerCase(); //get the lower case of the string
